...
import copy
import random
instructions = open("seventeen-in-2.txt").read()
...
class ScaffoldRobot(object):
	...
	def __init__(self):
		...
		# inputs = [65, 44, 66, 44, 67, 44, 66, 44, 65, 44, 67, 10, 82, 44, 56, 44, 82, 44, 56, 10, 82, 44, 52, 44, 82, 44, 52, 44, 82, 44, 56, 10, 76, 44, 54, 44, 76, 44, 50, 10, 121, 10]
		inputs.reverse()
		print(inputs)
